	...
	<a href="<?php echo $external_link; ?>" target="_blank" title="<?php the_title(); ?>"> <?php the_post_thumbnail(); ?></a> <?php } ?>
		...
		<section class="archiveSection">
                   ...
                   <section class="postArea">
                                <?php
                               $args = array( 'posts_per_page' => 3, 'category' => 9 );
...
<?php if($external_link == ""){ ?>
	...
	<a href="<?php echo $external_link; ?>" target="_blank" title="<?php the_title(); ?>"> <?php the_post_thumbnail(); ?></a> <?php } ?>   
                    ...
                    <section class="postArea">
                                <?php
                               $args = array( 'posts_per_page' => 3, 'offset' => 3, 'category' => 9 );
                               $lastposts = get_posts( $args );
                               foreach ( $lastposts as $post ) :
                                 setup_postdata( $post ); ?>
...
<?php if($external_link == ""){ ?>
	...
	<a href="<?php echo $external_link; ?>" target="_blank" title="<?php the_title(); ?>"> <?php the_post_thumbnail(); ?></a> <?php } ?>     
                    ...
                    <section class="postArea">
                                <?php
                               $args = array( 'posts_per_page' => 3, 'offset' => 6, 'category' => 9 );
                               $lastposts = get_posts( $args );
                               foreach ( $lastposts as $post ) :
                                 setup_postdata( $post ); ?>
...
<?php if($external_link == ""){ ?>
	...
	<a href="<?php echo $external_link; ?>" target="_blank" title="<?php the_title(); ?>"> <?php the_post_thumbnail(); ?></a> <?php } ?>     
                    ...
                    <section class="postArea">
                                <?php
                               $args = array( 'posts_per_page' => 3, 'offset' => 9, 'category' => 9 );
                               $lastposts = get_posts( $args );
                               foreach ( $lastposts as $post ) :
                                 setup_postdata( $post ); ?>
...
<?php if($external_link == ""){ ?>
	...
	<a href="<?php echo $external_link; ?>" target="_blank" title="<?php the_title(); ?>"> <?php the_post_thumbnail(); ?></a> <?php } ?>     
                    ...
                    <section class="postArea">
                                <?php
                               $args = array( 'posts_per_page' => 3, 'offset' => 12, 'category' => 9 );
                               $lastposts = get_posts( $args );
                               foreach ( $lastposts as $post ) :
                                 setup_postdata( $post ); ?>
...
<?php if($external_link == ""){ ?>
	...
	<a href="<?php echo $external_link; ?>" target="_blank" title="<?php the_title(); ?>"> <?php the_post_thumbnail(); ?></a> <?php } ?>     
                    ...
                    <section class="postArea">
                                <?php
                               $args = array( 'posts_per_page' => 3, 'offset' => 15, 'category' => 9 );
                               $lastposts = get_posts( $args );
                               foreach ( $lastposts as $post ) :
                                 setup_postdata( $post ); ?>
...
<?php if($external_link == ""){ ?>
	...
	<a href="<?php echo $external_link; ?>" target="_blank" title="<?php the_title(); ?>"> <?php the_post_thumbnail(); ?></a> <?php } ?>     
                    ...
                    <section class="postArea">
                                <?php
                               $args = array( 'posts_per_page' => 3, 'offset' => 18, 'category' => 9 );
                               $lastposts = get_posts( $args );
                               foreach ( $lastposts as $post ) :
                                 setup_postdata( $post ); ?>
