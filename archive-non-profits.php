	...
	<a href="<?php echo $external_link; ?>" target="_blank" title="<?php the_title(); ?>"> <?php the_post_thumbnail(); ?></a> <?php } ?>
		...
		<section class="archiveSection">
                    ...
                    <div class="topPageSocials" id="mobileOnly">
                        ...
                        <a href="#/"><a href="https://plus.google.com/share?url=<?php the_permalink();?>&t=<?php the_title(); ?>" target="_blank"><i class="fa fa-google-plus" aria-hidden="true"></i></a>
                   ...
                   <section class="postArea">
                                <?php
                               $args = array( 'posts_per_page' => 3, 'category' => 10 );
...
<?php if($external_link == ""){ ?>
	...
	<a href="<?php echo $external_link; ?>" target="_blank" title="<?php the_title(); ?>"> <?php the_post_thumbnail(); ?></a> <?php } ?>   
                    ...
                    <section class="postArea">
                                <?php
                               $args = array( 'posts_per_page' => 3, 'offset' => 3, 'category' => 10 );
                               $lastposts = get_posts( $args );
                               foreach ( $lastposts as $post ) :
                                 setup_postdata( $post ); ?>
...
<?php if($external_link == ""){ ?>
	...
	<a href="<?php echo $external_link; ?>" target="_blank" title="<?php the_title(); ?>"> <?php the_post_thumbnail(); ?></a> <?php } ?>     
                    ...
                    <section class="postArea">
                                <?php
                               $args = array( 'posts_per_page' => 3, 'offset' => 6, 'category' => 10 );
                               $lastposts = get_posts( $args );
                               foreach ( $lastposts as $post ) :
                                 setup_postdata( $post ); ?>
...
<?php if($external_link == ""){ ?>
	...
	<a href="<?php echo $external_link; ?>" target="_blank" title="<?php the_title(); ?>"> <?php the_post_thumbnail(); ?></a> <?php } ?>     
                    ...
                    <section class="postArea">
                                <?php
                               $args = array( 'posts_per_page' => 3, 'offset' => 9, 'category' => 10 );
                               $lastposts = get_posts( $args );
                               foreach ( $lastposts as $post ) :
                                 setup_postdata( $post ); ?>
