                        ...
                        <article class="thePost">  
                            ...
                            <div class="rightSection"> 
                                    <div class="addCalendar" id="deskTopOnly">
                                        <a href="<?php echo get_post_meta($post->ID, 'calendar', true); ?>"><h3>Add to calendar <i class="fa fa-calendar" aria-hidden="true"></i></h3></a>
                                    </div>
...
<?php if($external_link == ""){ ?>
	...
	<a href="<?php echo $external_link; ?>" target="_blank" title="<?php the_title(); ?>"> <?php the_post_thumbnail(); ?></a> <?php } ?>   
                    ...
                    <section class="postArea">
                                <?php
                               $args = array( 'posts_per_page' => 3, 'offset' => 3, 'category' => 6 );
                               $lastposts = get_posts( $args );
                               foreach ( $lastposts as $post ) :
                                 setup_postdata( $post ); ?>
...
<?php if($external_link == ""){ ?>
	...
	<a href="<?php echo $external_link; ?>" target="_blank" title="<?php the_title(); ?>"> <?php the_post_thumbnail(); ?></a> <?php } ?>     
                    ...
                    <section class="postArea">
                                <?php
                               $args = array( 'posts_per_page' => 3, 'offset' => 6, 'category' => 6 );
                               $lastposts = get_posts( $args );
                               foreach ( $lastposts as $post ) :
                                 setup_postdata( $post ); ?>
...
<?php if($external_link == ""){ ?>
	...
	<a href="<?php echo $external_link; ?>" target="_blank" title="<?php the_title(); ?>"> <?php the_post_thumbnail(); ?></a> <?php } ?>     
                    ...
                    <section class="postArea">
                                <?php
                               $args = array( 'posts_per_page' => 3, 'offset' => 9, 'category' => 6 );
                               $lastposts = get_posts( $args );
                               foreach ( $lastposts as $post ) :
                                 setup_postdata( $post ); ?>
...
<?php if($external_link == ""){ ?>
	...
	<a href="<?php echo $external_link; ?>" target="_blank" title="<?php the_title(); ?>"> <?php the_post_thumbnail(); ?></a> <?php } ?>     
                    ...
                    <section class="postArea">
                                <?php
                               $args = array( 'posts_per_page' => 3, 'offset' => 12, 'category' => 6 );
                               $lastposts = get_posts( $args );
                               foreach ( $lastposts as $post ) :
                                 setup_postdata( $post ); ?>
...
<?php if($external_link == ""){ ?>
	...
	<a href="<?php echo $external_link; ?>" target="_blank" title="<?php the_title(); ?>"> <?php the_post_thumbnail(); ?></a> <?php } ?>     
                    ...
                    <section class="postArea">
                                <?php
                               $args = array( 'posts_per_page' => 3, 'offset' => 15, 'category' => 6 );
                               $lastposts = get_posts( $args );
                               foreach ( $lastposts as $post ) :
                                 setup_postdata( $post ); ?>
